...
public class DateTimeOffsetTests : IDisposable
{
    ...
    [Theory]
    //[InlineData(24, ExpectedException = typeof(ArgumentOutOfRangeException))]
    ...
    [InlineData(999)]
    // [InlineData(-1, ExpectedException = typeof(ArgumentOutOfRangeException))]
    //[InlineData(1000, ExpectedException = typeof(ArgumentOutOfRangeException))]
